...
if __name__ == '__main__':
    ...
    # !MOCK paths: adjust according to your need
    ...
    fs = 1000
    win_len = int(.4*(fs/downsmpl_rate))
    crit_plv = .1
    ...
    for i in range(pool_size):
        ...
        tmp_dict = {
            'x_smooth' : copy.deepcopy(x_smooth),
